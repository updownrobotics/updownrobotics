...
const technologies = [
	{
		...
		title: "AI & SLAM",
		description:
			"Simultaneous Localization and Mapping enables real-time environment understanding and autonomous navigation",
	},
	{
		icon: Cpu,
		title: "Sensor Fusion",
		description:
			"Multi-sensor integration combining LiDAR, cameras, and IMU for comprehensive environmental awareness",
	},
	{
		icon: Brain,
		title: "Navigation Intelligence",
		description:
			"Advanced path planning and obstacle avoidance powered by machine learning algorithms",
	},
	{
		icon: Droplet,
		title: "Cleaning Architecture",
		description:
			"5-stage integrated system: sweeping, scrubbing, mopping, drying, and disinfection",
	},
	{
		icon: Gauge,
		title: "Multi-Floor Logic",
		description:
			"Intelligent elevator integration and floor-mapping for seamless multi-level operations",
	},
	{
		icon: Radio,
		title: "Autonomous Docking",
		description:
			"Self-charging system with precision docking and automatic water tank management",
	},
];
				...
				<div className="container mx-auto">
					...
					>
						<h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-heading font-bold mb-6">
							...
							<span className="gradient-heading">Intelligent Cleaning</span>
						</h1>
						<p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
							Cutting-edge robotics, AI, and mechanical engineering converge to
							create India's most advanced cleaning solution
						</p>
					</motion.div>

					{/* Hero Image Section */}
					<div
						className={`mb-24 relative transition-all duration-700 ${
							heroImageReveal.isVisible
					...
					>
						...
						<div
							className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72 border-2 border-primary/20 rounded-full animate-glow-pulse"
					...
					<div
						ref={specsReveal.ref}
						className={`mt-24 grid lg:grid-cols-2 gap-12 transition-all duration-700 ${
							specsReveal.isVisible
								? "opacity-100 translate-y-0"
								: "opacity-0 translate-y-10"
						}`}
					>
						<div className="p-8 bg-gradient-to-br from-card to-card/50 border border-border rounded-2xl">
							...
							<ul className="space-y-4">
								<li className="flex items-start gap-3">
									...
									<span>
										<strong>Real-time Mapping:</strong> Updates environmental maps
										at 10Hz
									</span>
								</li>
								<li className="flex items-start gap-3">
									<Zap className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
									<span>
										<strong>Obstacle Detection:</strong> 360° awareness with
										multi-sensor fusion
									</span>
								</li>
								<li className="flex items-start gap-3">
									<Zap className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
									<span>
										<strong>Path Optimization:</strong> Dynamic route planning for
										efficiency
									</span>
								</li>
							</ul>
						...
						<div className="p-8 bg-gradient-to-br from-card to-card/50 border border-border rounded-2xl">
							<h2 className="text-3xl font-heading font-bold mb-6">
								Cleaning{" "}
								<span className="text-electric-cyan">Performance</span>
							</h2>
							<ul className="space-y-4">
								<li className="flex items-start gap-3">
									<Droplet className="w-5 h-5 text-electric-cyan mt-1 flex-shrink-0" />
									<span>
										<strong>5-Stage Process:</strong> Comprehensive cleaning in one
										pass
									</span>
								</li>
								<li className="flex items-start gap-3">
									<Droplet className="w-5 h-5 text-electric-cyan mt-1 flex-shrink-0" />
									<span>
										<strong>Water Management:</strong> Intelligent flow control and
										tank monitoring
									</span>
								</li>
								<li className="flex items-start gap-3">
									<Droplet className="w-5 h-5 text-electric-cyan mt-1 flex-shrink-0" />
									<span>
										<strong>Surface Adaptation:</strong> Auto-adjusts to tile,
										marble, and wood
									</span>
								</li>
							</ul>
