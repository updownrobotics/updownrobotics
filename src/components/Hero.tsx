  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 pt-24 pb-32 bg-gradient-to-b from-deep-black via-background to-background">
      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="mt-32 mb-16 text-center max-w-5xl mx-auto animate-fade-in relative z-20" style={{ animationDelay: '0.4s' }}>
          <div className="p-8 bg-background border border-border rounded-2xl shadow-lg shadow-primary/30">
