  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "fade-in": "fade-in 0.618s ease-out",
        "glow-pulse": "glow-pulse 1.618s ease-in-out infinite",
        "float": "float 2.618s ease-in-out infinite",
        "pulse-slow": "pulse-slow 2.618s ease-in-out infinite",
        "circuit-line": "circuit-line 2.618s linear infinite",
        "slide-up": "slide-up 0.618s ease-out",
        "scale-in": "scale-in 0.382s ease-out"
      },
      transitionDuration: {
        'phi-fast': '382ms',
        'phi': '618ms',
